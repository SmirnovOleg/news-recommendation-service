...
# COPY only if the `.model/` directory exists. Otherwise, the model will be downloaded.
# Workaround from https://forums.docker.com/t/copy-only-if-file-exist/3781/3
COPY app/__init__.py .model*/ .model/
